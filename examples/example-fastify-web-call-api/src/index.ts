...
// Build the Fastify app. Exported so the test suite can drive it with
// `fastify.inject()` without binding a port.
...
// the test suite (which drives the app via `fastify.inject()`).
